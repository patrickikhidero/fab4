      ...
      <div className="max-w-6xl mx-auto min-w-0">
        <div className="bg-white rounded-[16px] sm:rounded-[20px] shadow-[0px_16px_32px_-8px_rgba(39,38,53,0.1)] p-4 sm:p-6 lg:p-8 min-w-0">
          ...
          <div className="mb-6 sm:mb-8 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <div className="flex items-start justify-start sm:justify-center min-w-[760px] sm:min-w-0 pr-4 sm:pr-0">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-end justify-start w-full min-w-0">
                    <div className="flex flex-col gap-2 w-full lg:w-[252px] shrink-0">
                      ...
                      <div className="bg-white flex gap-2 h-12 items-center justify-start pl-4 pr-3 py-3 relative rounded-[8px] w-full min-w-0">
                        ...
                        <div className="bg-white flex gap-2 items-center justify-center px-2 py-1 relative rounded-[999px] shrink-0 max-w-[120px]">
                          ...
                          <input
                            ...
                            className="w-[52px] uppercase bg-transparent outline-none text-[#272635] text-[14px] sm:text-[16px]"
                          />
                        </div>
                      </div>
                    </div>
