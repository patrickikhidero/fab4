...
//   const [activeSection, setActiveSection] = useState<'application' | 'status' | 'campaign' | 'wallet'>('campaign')
...
export function CampaignOverview() {
  ...
  useEffect(() => {
    const run = async () => {
      try {
        ...
        // Donations for donor table (still by current campaign)
        if (campaignId) {
          const donationRes = await listDonationsByCampaign(campaignId)
  ...
  // Optional: block UI if not verified (your product rule)
  if (!isVerified) {
    return (
      <div className="flex min-h-screen bg-[#eceee4] items-center justify-center">
        ...
        <div className="min-h-screen bg-[#eceee4]">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-[20px] shadow-[0px_16px_32px_-8px_rgba(39,38,53,0.1)] p-8">
              ...
              {/* Header Section */}
              <div className="content-stretch flex items-center justify-between relative size-full mb-8">
                <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[28px] text-nowrap">
                  <p className="leading-[normal] whitespace-pre">Campaign</p>
                </div>
                ...
                <div
                  ...
                  onClick={() => router.push('/student/dashboard/campaign/create')}
                >
                  <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[16px] text-nowrap">
                    <p className="leading-none whitespace-pre">Create Campaign</p>
                  </div>
                  <div className="overflow-clip relative shrink-0 size-5">
                    ...
                    <div className="absolute bottom-[34.38%] left-[34.38%] right-1/4 top-1/4">
                      <div className="absolute inset-[-7.692%]">
                        <img alt="Arrow Detail 2" className="block max-w-none size-full" src={imgArrow2} />
                      </div>
                    </div>
              ...
              {/* Overview Section */}
              <div className="content-stretch flex gap-10 items-start justify-start relative size-full mb-8">
                <div className="content-stretch flex flex-col font-['Neue_Montreal:Regular',_sans-serif] gap-2 items-start justify-start relative shrink-0">
                  <div className="relative shrink-0 text-[#272635] text-[18px] text-nowrap uppercase">
                    <p className="leading-[normal] whitespace-pre">overview of campaigns</p>
                  </div>
                  <div className="relative shrink-0 text-[16px] text-[rgba(39,38,53,0.5)] w-[277px]">
                ...
                <div className="basis-0 content-stretch flex gap-5 grow items-start justify-start min-h-px min-w-px relative shrink-0">
                  {/* Campaign Goal Card */}
                  <div className="basis-0 box-border content-stretch flex flex-col grow items-start justify-between min-h-px min-w-px p-[16px] relative rounded-[12px] self-stretch shrink-0">
                    <div aria-hidden="true" className="absolute border border-[rgba(39,38,53,0.1)] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)]" />

                    <div className="content-stretch flex gap-2.5 items-start justify-start relative shrink-0 w-full">
                      <div className="basis-0 content-stretch flex flex-col font-['Neue_Montreal:Regular',_sans-serif] gap-2 grow items-start justify-start min-h-px min-w-px relative shrink-0">
                        <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-full">
                          <div className="relative shrink-0 text-[#272635] text-[14px] uppercase">
                            <p className="leading-[normal]">campaign goal</p>
                          </div>
                          <div className="bg-yellow-100 px-2 py-1 rounded-full">
                            <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[10px] text-nowrap">
                        ...
                        <div className="relative shrink-0 text-[28px] text-[#272635] w-full">
                          <p className="leading-[normal]">${metrics.goal.toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="h-0 relative shrink-0 w-full">
                      <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                        <img alt="Line" className="block max-w-none size-full" src={imgLine1} />
                      </div>
                    </div>

                    <div className="content-stretch flex flex-col items-start justify-start relative shrink-0 w-full">
                      <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-full">
                        <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#198754] text-[12px] text-nowrap">
                          <p className="leading-[normal] whitespace-pre">View Status</p>
                        </div>
                        <div className="overflow-clip relative shrink-0 size-4" data-name="Arrow Right">
                          <div className="absolute inset-0" data-name="Vector">
                            <img alt="Arrow" className="block max-w-none size-full" src={imgArrow} />
                          </div>
                        </div>
                    ...
                    <div className="content-stretch flex gap-2.5 items-start justify-start relative shrink-0 w-full">
                      <div className="basis-0 content-stretch flex flex-col font-['Neue_Montreal:Regular',_sans-serif] gap-2 grow items-start justify-start min-h-px min-w-px relative shrink-0">
                        ...
                        <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-full">
                          ...
                          <div className="relative shrink-0 text-[#272635] text-[12px]">
                            <p className="leading-[normal]">{metrics.academicSessions} Academic year</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              {/* Donor History Section */}
              <div className="content-stretch flex items-start justify-between relative size-full mb-8">
                <div className="content-stretch flex flex-col font-['Neue_Montreal:Regular',_sans-serif] gap-2 items-start justify-start relative shrink-0 w-[508px]">
                  <div className="relative shrink-0 text-[#272635] text-[18px] text-nowrap uppercase">
                    <p className="leading-[normal] whitespace-pre">history of donors</p>
                  </div>
                  <div className="relative shrink-0 text-[16px] text-[rgba(39,38,53,0.5)] w-full">
                    <p className="leading-[24px]">
                      This is the performance of all campaign created for you over the period of your academics
                    </p>
                  </div>
                ...
                <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-[77px] h-4">
                  <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[12px] text-nowrap">
                    <p className="leading-[normal] whitespace-pre">Current</p>
                  </div>
                  <div className="overflow-clip relative shrink-0 size-4" data-name="Caret Down">
                    <div className="absolute inset-0" data-name="Vector">
                      <img alt="Caret Down" className="block max-w-none size-full" src="/svg/icons/dropdown-arrow.svg" />
                    </div>
                  </div>
              ...
              {/* Tab Navigation */}
              <div className="content-stretch flex gap-8 items-center justify-start relative size-full mb-6">
                <div className="content-stretch flex gap-8 items-center justify-start relative shrink-0">
                  <button
                    ...
                    className={`font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[16px] text-nowrap pb-2 border-b-2 transition-colors ${
                      activeTab === 'all' ? 'text-[#198754] border-[#198754]' : 'text-[rgba(39,38,53,0.5)] border-transparent'
                    }`}
                  >
                    <p className="leading-[normal] whitespace-pre">All donors</p>
                  </button>
                  ...
                  <button
                    ...
                    className={`font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[16px] text-nowrap pb-2 border-b-2 transition-colors ${
                      activeTab === 'guardians' ? 'text-[#198754] border-[#198754]' : 'text-[rgba(39,38,53,0.5)] border-transparent'
                    }`}
                  >
                    <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0">
                      <p className="leading-[normal] whitespace-pre">Guardians</p>
                      <div className="bg-[rgba(39,38,53,0.1)] px-2 py-1 rounded-full">
                        <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[10px] text-nowrap">
                          <p className="leading-[normal] whitespace-pre">{donorCounts.guardians}</p>
                        </div>
                      </div>
                  ...
                  <button
                    ...
                    className={`font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[16px] text-nowrap pb-2 border-b-2 transition-colors ${
                      activeTab === 'good-samaritans' ? 'text-[#198754] border-[#198754]' : 'text-[rgba(39,38,53,0.5)] border-transparent'
                    }`}
                  >
                    <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0">
                      <p className="leading-[normal] whitespace-pre">Good samaritans</p>
              ...
              {/* Donor Table */}
              <div className="content-stretch flex flex-col items-start justify-start relative size-full mb-8">
                <div className="bg-white box-border content-stretch flex flex-col items-start justify-start relative rounded-[12px] shrink-0 w-full border border-[rgba(39,38,53,0.1)]">
                  {/* Table Header */}
                  <div className="content-stretch flex items-center justify-start relative shrink-0 w-full border-b border-[rgba(39,38,53,0.1)]">
                    <div className="content-stretch flex flex-col items-start justify-center min-h-[44px] px-4 py-3 relative shrink-0 w-[279px]">
                      <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[12px] text-nowrap uppercase">
                        <p className="leading-[normal] whitespace-pre">Names</p>
                      </div>
                    </div>
                    <div className="content-stretch flex flex-col items-start justify-center min-h-[44px] px-4 py-3 relative shrink-0 w-[240px]">
                      <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[12px] text-nowrap uppercase">
                        <p className="leading-[normal] whitespace-pre">Donation</p>
                      </div>
                    </div>
                  ...
                  <div className="content-stretch flex flex-col items-start justify-start relative shrink-0 w-full">
                    {paginatedDonors.length === 0 ? (
                      <div className="px-6 py-14 flex flex-col items-center justify-center text-center w-full">
                        <div className="mt-1 text-[14px] font-medium text-[rgba(39,38,53,0.75)]">No donors to show</div>
                      ...
                      paginatedDonors.map((donor, index) => (
                        <div
                          key={donor.id}
                          className={`content-stretch flex items-center justify-start relative shrink-0 w-full ${
                            index < paginatedDonors.length - 1 ? 'border-b border-[rgba(39,38,53,0.1)]' : ''
                          }`}
                        >
                          <div className="content-stretch flex flex-col items-start justify-center min-h-[48px] px-4 py-3 relative shrink-0 w-[279px]">
                            <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[14px] text-nowrap">
                              <p className="leading-[normal] whitespace-pre">{donor.name}</p>
                            </div>
                          </div>
                          <div className="content-stretch flex flex-col items-start justify-center min-h-[48px] px-4 py-3 relative shrink-0 w-[240px]">
                            <div className="font-['Neue_Montreal:Regular',_sans-serif] relative shrink-0 text-[#272635] text-[14px] text-nowrap">
                              <p className="leading-[normal] whitespace-pre">${donor.amount.toFixed(2)}</p>
                            </div>
                          </div>
                  ...
                  {/* Pagination */}
                  <div className="content-stretch flex items-center justify-end relative shrink-0 w-full px-4 py-3">
                    <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0">
                      <button
                        onClick={() => setCurrentPage(Math.max(1, currentPage - 1))}
                        disabled={currentPage === 1}
                      ...
                      >
                        <div className="overflow-clip relative shrink-0 size-5" data-name="Caret Left">
                          <div className="absolute inset-0" data-name="Vector">
                            <img alt="Caret Left" className="block max-w-none size-full" src={imgCaretLeft} />
                          </div>
                        </div>
                      ...
                      >
                        <div className="overflow-clip relative shrink-0 size-5" data-name="Caret Right">
                          <div className="absolute inset-0" data-name="Vector">
                            <img alt="Caret Right" className="block max-w-none size-full" src={imgCaretRight} />
                          </div>
                        </div>
              ...
              {/* Footer */}
              <div className="content-stretch flex font-['Neue_Montreal:Regular',_sans-serif] gap-5 items-center justify-start relative shrink-0 text-[14px] text-[rgba(39,38,53,0.5)] text-nowrap w-full">
