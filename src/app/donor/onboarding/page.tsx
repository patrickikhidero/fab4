...
import { getStoredUser, setAuthTokens, getAccessToken, getRefreshToken } from "@/lib/auth/storage";
...
export default function DonorOnboardingPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!firstName.trim()) {
      showToast("warning", "Please enter your first name.", "Missing field");
      return;
    }

    if (!lastName.trim()) {
      showToast("warning", "Please enter your last name.", "Missing field");
      return;
    }
    ...
    try {
      ...
      showToast("success", "Profile completed successfully!", "Welcome");
      router.replace("/donor");
    } catch (err: any) {
      const msg =
            ...
            <div className="w-full min-w-0">
              <div className="mt-4 sm:mt-8 md:mt-16 lg:mt-24">
                ...
                <p className="mt-4 max-w-[420px] text-sm leading-6 text-[var(--color-muted)]">
                  Tell us your name so we can personalize your donor experience.
                </p>
